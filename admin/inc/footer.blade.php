 <!-- footer -->
    ...
    <script src="package/js/bootstrap.bundle.min.js"></script>
    <!-- Theme Required Js -->
    <script src="package/js/app.min.js"></script>
    <script src="package/js/app.init.js"></script>
    <script src="package/js/app-style-switcher.js"></script>
    <!-- perfect scrollbar JavaScript -->
    <script src="package/js/perfect-scrollbar.jquery.js"></script>
    <script src="package/js/jquery.sparkline.min.js"></script>
    <!--Wave Effects -->
    <script src="package/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="package/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="package/js/feather.min.js"></script>
    <script src="package/js/custom.min.js"></script>
    <!-- --------------------------------------------------------------- -->
    <!-- This page JavaScript -->
    <!-- --------------------------------------------------------------- -->
    <script src="package/js/apexcharts.min.js"></script>
    <script src="package/js/dashboard1.js"></script>
  </body>
</html>
