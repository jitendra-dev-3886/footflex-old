              ...
              <div class="top"> <!-- top -->
                  <div class="container">
                      <ul class="top-support"> 
                          <li><i class="fa fa-phone-square"></i><span>+91 9125173886</span></li>
                          <li><a href=""><i class="fa fa-envelope-square"></i><span>footflex91@gmail.com</span></a></li>
                      </ul>
                          ...
                          <nav class="navbar navbar-default">
                              <!-- <div class="container-fluid"> -->
                                  ...
                                  <div class="navbar-header">
                                      ...
                                      <a class="navbar-brand" href="/"><img src="images/Screenshot_1.png" alt="" height="30px" width="150px"></a>
                                  </div>
